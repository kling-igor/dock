...
export default {
  ...
  sideBar: {
    background: "#000000", //Side Bar background color.
    foreground: "#ffffff", //Side Bar foreground color. The Side Bar is the container for views like Explorer and Search.
    border: "#ff0000" //Side Bar border color on the side separating the editor.
  },

  sideBarTitle: {
    foreground: "#ffffff" //Side Bar title foreground color.
  },
  sideBarSectionHeader: {
    background: "#000000", // Side Bar section header background color.
    foreground: "#ffffff", // Side Bar section header foreground color.
  ...
  statusBar: {
    background: "#1374ca", // Standard Status Bar background color.
    foreground: "#ffffff", // Status Bar foreground color.
    border: "#1374ca", // Status Bar border color separating the Status Bar and editor.
  ...
  statusBarItem: {
    activeBackground: "#0000ff", // Status Bar item background color when clicking.
    hoverBackground: "#0000ff", // Status Bar item background color when hovering.
    prominentBackground: "#00ffff", // Status Bar prominent items background color. Prominent items stand out from other Status Bar entries to indicate importance.
    prominentHoverBackground: "#00ffff" // Status Bar prominent items background color when hovering. Prominent items stand out from other Status Bar entries to indicate importance.
  },
  activityBar: {
